...
public class KLCityPickerView: UIView {
    ...
    /// 创建城市选择器
     lazy var pickerView: UIPickerView = {
       let pickerView = UIPickerView(frame: CGRect(x: 0, y: 44, width:screenWidth , height: 214))
    ...
    /// 创建容器
     lazy var containView: UIView = {
        let containView = UIView(frame: CGRect(x: 0, y: screenHeight, width:screenWidth , height: 259))
    ...
    /// 创建容器中的titleToolBar
     lazy var titleToolBar: UIView = {
        let titleToolBar = UIView(frame: CGRect(x: 0, y: 0, width: screenWidth, height: 44))
    ...
    /// 创建确定按钮
     lazy var sureButton: UIButton = {
        let sureButton = UIButton(frame: CGRect(x: screenWidth - 65, y: 0, width: 65, height: 44))
    ...
    /// 创建取消按钮
     lazy var cancleButton: UIButton = {
        let cancleButton = UIButton(frame: CGRect(x: 0, y: 0, width: 65, height: 44))
    ...
    /// 显示view
     func showView() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.containView.kl_bottom = screenHeight
        }
    }
    ...
    /// 隐藏View
     func hideView() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.containView.kl_y =  screenHeight
        }) { (finish) in
