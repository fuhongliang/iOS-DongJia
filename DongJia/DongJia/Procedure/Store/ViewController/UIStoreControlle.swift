...
class UIStoreControlle: UBaseViewController {
...
extension UIStoreControlle: UITableViewDelegate, UITableViewDataSource{
...
//            let data = [storeInfoData!.goods_list[0],storeInfoData!.goods_list[1]]
